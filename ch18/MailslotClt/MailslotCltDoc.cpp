...
// MailslotCltDoc.cpp: CMailslotCltDoc 类的实现
//
...
// CMailslotCltDoc 构造/析构

CMailslotCltDoc::CMailslotCltDoc() noexcept
{
	// TODO: 在此添加一次性构造代码
...
// 缩略图的支持
void CMailslotCltDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
	// 修改此代码以绘制文档数据
...
// 搜索处理程序的支持
void CMailslotCltDoc::InitializeSearchContent()
{
...
void CMailslotCltDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
