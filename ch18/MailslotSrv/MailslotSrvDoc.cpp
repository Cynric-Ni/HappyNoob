...
// MailslotSrvDoc.cpp: CMailslotSrvDoc 类的实现
//
...
// CMailslotSrvDoc 构造/析构

CMailslotSrvDoc::CMailslotSrvDoc() noexcept
{
	// TODO: 在此添加一次性构造代码
...
// 缩略图的支持
void CMailslotSrvDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
	// 修改此代码以绘制文档数据
...
// 搜索处理程序的支持
void CMailslotSrvDoc::InitializeSearchContent()
{
...
void CMailslotSrvDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
