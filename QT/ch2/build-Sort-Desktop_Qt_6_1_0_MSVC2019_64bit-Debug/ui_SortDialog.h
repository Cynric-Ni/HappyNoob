...
public:
    ...
    void setupUi(QDialog *SortDialogClass)
    {
        if (SortDialogClass->objectName().isEmpty())
            SortDialogClass->setObjectName(QString::fromUtf8("SortDialogClass"));
        SortDialogClass->resize(297, 316);
        ...
        teriaryGroupBox = new QGroupBox(SortDialogClass);
        ...
        QObject::connect(okButton, &QPushButton::clicked, SortDialogClass, qOverload<>(&QDialog::accept));
        QObject::connect(cancelButton, &QPushButton::clicked, SortDialogClass, qOverload<>(&QDialog::reject));
    ...
    {
        SortDialogClass->setWindowTitle(QCoreApplication::translate("SortDialogClass", "SortDialog", nullptr));
        okButton->setText(QCoreApplication::translate("SortDialogClass", "OK", nullptr));
        secondaryGroupBox->setTitle(QCoreApplication::translate("SortDialogClass", "&Secondary Key", nullptr));
        label_3->setText(QCoreApplication::translate("SortDialogClass", "Order", nullptr));
        label_4->setText(QCoreApplication::translate("SortDialogClass", "Column", nullptr));
        secondaryColumnCombo->setItemText(0, QCoreApplication::translate("SortDialogClass", "None", nullptr));

        comboBox_4->setItemText(0, QCoreApplication::translate("SortDialogClass", "Ascending", nullptr));
        comboBox_4->setItemText(1, QCoreApplication::translate("SortDialogClass", "Descending", nullptr));

        teriaryGroupBox->setTitle(QCoreApplication::translate("SortDialogClass", "&Teritary Key", nullptr));
        label_5->setText(QCoreApplication::translate("SortDialogClass", "Order", nullptr));
        tertiaryColumnCombo->setItemText(0, QCoreApplication::translate("SortDialogClass", "None", nullptr));

        comboBox_6->setItemText(0, QCoreApplication::translate("SortDialogClass", "Ascending", nullptr));
        comboBox_6->setItemText(1, QCoreApplication::translate("SortDialogClass", "Descending", nullptr));

        label_6->setText(QCoreApplication::translate("SortDialogClass", "Column", nullptr));
        primaryGroupBox->setTitle(QCoreApplication::translate("SortDialogClass", "&Primary Key", nullptr));
        primaryColumnCombo->setItemText(0, QCoreApplication::translate("SortDialogClass", "None", nullptr));

        label_2->setText(QCoreApplication::translate("SortDialogClass", "Order", nullptr));
        comboBox_2->setItemText(0, QCoreApplication::translate("SortDialogClass", "Ascending", nullptr));
        comboBox_2->setItemText(1, QCoreApplication::translate("SortDialogClass", "Descending", nullptr));

        label->setText(QCoreApplication::translate("SortDialogClass", "Column", nullptr));
        cancelButton->setText(QCoreApplication::translate("SortDialogClass", "Cancel", nullptr));
        moreButton->setText(QCoreApplication::translate("SortDialogClass", "&More", nullptr));
    } // retranslateUi
