...
CParentDoc::CParentDoc() noexcept
{
	// TODO: 在此添加一次性构造代码
...
// 缩略图的支持
void CParentDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
	// 修改此代码以绘制文档数据
...
// 搜索处理程序的支持
void CParentDoc::InitializeSearchContent()
{
...
void CParentDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
